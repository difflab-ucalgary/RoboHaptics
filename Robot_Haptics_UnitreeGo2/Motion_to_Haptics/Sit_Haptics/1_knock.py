...
class Go2Leg:
    def __init__(self):
        ...
        self._sitonFootPos1 = [0.0, 0.0, -2.75, 0.0, 1.5, -2.75, 0.0, 2.85, -2.83, 0.0, 2.85, -2.83]
    ...
    def fr_knock_ten(self,
        ...
        for i1 in range(10):
            ...
            self._move_fr_to(contact_q, t_move=0.1, kp=60.0, kd=4.0)
            ...
            while time.time() - t0 < hold_s:
                for j in range(3):
                    ...
                    self.cmd.motor_cmd[i].dq   = 0.0
                    self.cmd.motor_cmd[i].tau  = 0.0
                self._lock_non_fr(kp=60.0, kd=5.0)
                self.send_cmd()
                time.sleep(0.01)
        # retreat
        self._move_fr_to(retreat_q, t_move=retreat_t, kp=55.0, kd=4.0)
        # finish position
