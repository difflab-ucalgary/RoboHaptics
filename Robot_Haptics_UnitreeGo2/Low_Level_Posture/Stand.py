...
class Go2Leg:
    ...
    def stand(self):
        ...
        self._hold_current_Pos(q_target= self._standPos, t_lock_time=3.0)
        
    def lay(self):
        self._move_all_to(self.laydownPos, t_move=1.5, hz=200, kp=55.0, kd=4.0)
        self._hold_current_Pos(q_target= self.laydownPos, t_lock_time=3.0)
...
if __name__ == '__main__':
    ...
    go2_leg.stand()
    # If need to lay down, uncomment the following line
    # go2_leg.lay()
